...
def main():
    ...
    if args.prompt_mode == 'list':
        prompt = (
            ...
            "Base your decision strictly on the visual evidence and the class definitions below.\n\n"
            ...
            "## building\n"
            "Building, skyscraper, house, bus stop building, garage, car port. If a building has a glass wall that you can see through, the wall is still building. Includes scaffolding and commercial signs attached to buildings.\n\n"
            "## wall\n"
            "Individual standing wall. Not part of a building.\n\n"
            "## fence\n"
            "Fence including any holes.\n\n"
            "## pole\n"
            "Small mainly vertically oriented pole. E.g. sign pole, traffic light poles. If the pole has a horizontal part (often for traffic light poles) this part is also considered pole. \n\n"
            "## traffic light\n"
            "The traffic light box without its poles.\n\n"
            "## traffic sign\n"
            "Sign installed from the state/city authority, usually for information of the driver/cyclist/pedestrian in an everyday traffic scene, e.g. traffic- signs, parking signs, direction signs - without their poles. No ads/commercial signs. Only the front side of a sign containing the information.\n\n"
            "## vegetation\n"
            "Tree, hedge, all kinds of vertical vegetation. \n\n"
            "## terrain\n"
            "Grass, all kinds of horizontal vegetation, soil or sand. These areas are not meant to be driven on.\n\n"
            "## sky\n"
            "Open sky, without leaves of tree. Includes thin electrical wires in front of the sky.\n\n"
            "## person\n"
            "People walking, standing or sitting on the ground, on a bench, on a chair. This class also includes toddlers, someone pushing a bicycle or standing next to it with both legs on the same side of the bicycle. This class includes anything that is carried by the person, e.g. backpack.\n\n"
            "## rider\n"
            "A human that would use some device to move. Includes, riders/drivers of bicycle, motorbike, scooter, skateboards, horses, roller-blades, wheel-chairs, road cleaning cars, cars without roof.\n\n"
            "## car\n"
            ...
            "## motorcycle\n"
            "Motorbike, moped, scooter without the driver.\n\n"
            "## bicycle\n"
            "Bicycle without the driver.\n\n"
            "Output format:\n"
